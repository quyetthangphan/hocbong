...
class SponsorThongTinDanhSachCaNhan extends StatefulWidget {
  const SponsorThongTinDanhSachCaNhan({Key key}) : super(key: key);

  @override
  _SponsorThongTinDanhSachCaNhanState createState() =>
      _SponsorThongTinDanhSachCaNhanState();
}

class _SponsorThongTinDanhSachCaNhanState
    extends State<SponsorThongTinDanhSachCaNhan> {
